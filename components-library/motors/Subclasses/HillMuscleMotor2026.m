...
classdef HillMuscleMotor2026 < Motor
    ...
    methods
        function obj = HillMuscleMotor2026(muscle_length, muscle_area, pennation_angle, muscle_vmax, fv_curvature, min_length, fl_curvature, specific_tension, r_activation, L_initial)
            ...
            if (fl_curvature < (min_length-1)^-3) | (fl_curvature > 0)
