...
classdef HillMuscleMotor < Motor
    ...
    methods
        function obj = HillMuscleMotor(muscle_length, muscle_area, pennation_angle, muscle_vmax, fv_curvature, min_length, fl_curvature, specific_tension, r_activation, L_initial)
